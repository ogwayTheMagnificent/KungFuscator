...
function EncryptStrings:CreateEncrypionService()
	...
	local function set_seed(seed_53)
		state_45 = seed_53 % 99999999999999
	...
	local function gen_seed()
		local seed;
		repeat
			seed = math.random(0, 99999999999999);
		until not usedSeeds[seed];
		return seed;
	end

	local function get_random_32()
		state_45 = (state_45 * param_mul_45 + param_add_45) % 99999999999999
		repeat
...
do
	...
	local function get_next_pseudo_random_byte()
		if #prev_values == 0 then
			state_45 = (state_45 * ]] .. tostring(param_mul_45) .. [[ + ]] .. tostring(param_add_45) .. [[) % 99999999999999
			repeat
